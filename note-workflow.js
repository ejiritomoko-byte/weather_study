...
const overviewTopics = [
  ...
  {
    title: "予報業務許可",
    body: "気象庁以外の者が気象や波浪などの予報業務を行う場合、気象業務法第17条に基づく許可が必要です。許可は予報業務の目的と範囲を定めて行われます。",
  },
  {
    title: "気象予報士の設置",
    body: "気象・地象の予報業務では、予報業務の範囲や資料に応じた科学的方法を用いた現象の予想を、気象予報士に行わせる必要があります。事業所ごとの必要人数や専任性も論点です。",
  },
  {
    title: "警報の制限",
    body: "気象庁以外の者は、原則として気象、地象、津波、高潮、波浪、洪水の警報をしてはならないとされています。予報と警報の権限の違いは法規問題で重要です。",
  },
  {
    title: "大気の鉛直構造",
  ...
  {
    title: "観測資料の利用",
    body: "気温、風、降水量、気圧、衛星、レーダーなどの観測は、実況把握と予報資料の初期値に使われます。観測環境、測器、品質管理を合わせて理解します。",
  },
  {
    title: "数値予報とガイダンス",
    body: "数値予報は観測、品質管理、データ同化、予報モデル、アンサンブル予報、ガイダンスを一連の流れで整理します。専門知識では、モデル出力をどう利用・補正するかが問われます。",
  },
  {
    title: "防災気象情報とキキクル",
    body: "警報・注意報、キキクル、短期予報解説資料などは、防災上の着目点を読み取る資料です。現象の理解だけでなく、危険度や警戒レベルとの関係を整理します。",
  },
  {
    title: "専門用語・季節予報用語",
    body: "専門用語集や季節予報用語集は、学科専門と実技答案の語彙を整える材料です。用語は意味だけでなく、どの資料・現象で使うかまでカード化します。",
  },
];
...
const overviewQuestions = [
  ...
  {
    text: "気象庁以外の事業者が気象の予報業務を行う場合、原則として必要なものはどれですか。",
    choices: ["気象庁長官の許可", "観光庁への届出", "任意の社内メモ", "資格不要の自由実施"],
    answer: 0,
    explanation: "気象業務法第17条により、気象庁以外の者が予報業務を行う場合は気象庁長官の許可が必要です。",
  },
  {
    text: "気象庁以外の者による警報について、原則として正しいものはどれですか。",
    choices: ["気象などの警報は原則としてしてはならない", "誰でも自由に警報を出せる", "警報は予報業務許可と無関係", "注意報だけでなく警報も民間が自由に出せる"],
    answer: 0,
    explanation: "気象業務法第23条では、気象庁以外の者による警報が原則として制限されています。",
  },
  {
    text: "予報業務で気象予報士に行わせるべき中心的な業務はどれですか。",
    choices: ["現象の予想", "経理処理だけ", "広告制作だけ", "測器の販売だけ"],
    answer: 0,
    explanation: "気象・地象の予報業務では、現象の予想を気象予報士に行わせることが重要な制度要件です。",
  },
  {
  ...
  {
    text: "数値予報で、観測データとモデルの推定を組み合わせて初期値を作る過程はどれですか。",
    choices: ["データ同化", "警報発表", "露場管理", "天気記号化"],
    answer: 0,
    explanation: "データ同化は、観測とモデルの情報を組み合わせて数値予報の初期値を作る過程です。",
  },
  {
    text: "ガイダンスの役割として最も近いものはどれですか。",
    choices: ["数値予報結果を統計的に補正し、予報要素へ変換する", "気象測器を校正するだけ", "法律条文を掲載するだけ", "過去問PDFを表示するだけ"],
    answer: 0,
    explanation: "ガイダンスは数値予報の出力を気温、降水確率などの予報要素に利用しやすくする資料です。",
  },
  {
    text: "キキクルを学ぶときの中心はどれですか。",
    choices: ["危険度を防災行動に結びつける", "色名だけを暗記する", "過去問番号だけを見る", "天気記号だけを描く"],
    answer: 0,
    explanation: "キキクルは危険度分布を把握し、警戒レベルや避難判断につなげる理解が大切です。",
  },
];
...
const cards = [
  ...
  {
    tag: "法規",
    front: "気象業務法第17条の中心は何ですか。",
    back: "気象庁以外の者が予報業務を行う場合、気象庁長官の許可が必要という点です。",
  },
  {
    tag: "法規",
    front: "気象業務法第23条で注意することは何ですか。",
    back: "気象庁以外の者は、原則として気象・地象・津波・高潮・波浪・洪水の警報をしてはならないという制限です。",
  },
  {
    tag: "法規",
    front: "予報業務許可の審査で見られる基本は何ですか。",
    back: "予報資料の収集・解析に関する施設や要員など、予報業務を適確に行う体制です。",
  },
  {
    tag: "法規",
    front: "気象予報士の設置で問われる中心は何ですか。",
    back: "予報業務の範囲や資料に応じ、科学的方法による現象の予想を気象予報士に行わせることです。",
  },
  {
    tag: "熱力学",
  ...
  {
    tag: "数値予報",
    front: "アンサンブル予報の狙いは何ですか。",
    back: "初期値やモデルの不確実性を複数の予報で表し、予報のばらつきや確率的な見通しを把握することです。",
  },
  {
    tag: "数値予報",
    front: "ガイダンスとは何ですか。",
    back: "数値予報の結果を統計的に補正し、気温、降水確率など利用しやすい予報要素に変換する資料です。",
  },
  {
    tag: "数値予報",
    front: "品質管理が必要な理由は何ですか。",
    back: "誤った観測値が初期値や解析に入ると、予報の精度に悪影響を与えるためです。",
  },
  {
    tag: "防災",
  ...
  {
    tag: "防災",
    front: "短期予報解説資料で確認したいことは何ですか。",
    back: "短期予報の考え方、防災事項、注目すべき現象や時間帯です。",
  },
  {
    tag: "防災",
    front: "警戒レベルと防災気象情報を学ぶ意味は何ですか。",
    back: "気象現象の危険度を、自治体の避難情報や住民の行動判断に結びつけるためです。",
  },
  {
    tag: "観測",
    front: "観測環境で注意することは何ですか。",
    back: "測器の設置場所、周囲の建物や地形、日射・風通しなどが観測値に影響する点です。",
  },
  {
    tag: "観測",
    front: "降水量の観測値を見るときの基本単位は何ですか。",
    back: "降水の深さに換算したmmです。時間雨量や積算雨量として読みます。",
  },
  {
    tag: "用語",
    front: "専門用語集をカード化するときのコツは何ですか。",
    back: "定義だけでなく、どの資料や現象で使うか、実技答案でどう書くかまで一緒に覚えます。",
  },
  {
    tag: "実技",
